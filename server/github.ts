...
export const FALLBACK_GITHUB_PROJECTS: GitHubProject[] = [
  ...
  { name: "Auto-Apply", description: "AI-powered job tracker and automated ATS resume scoring engine with match filtering, candidate-profile parsing, and MongoDB Atlas integration.", url: "https://github.com/Samarssj/Auto-Apply", homepageUrl: "https://auto-apply-datn.onrender.com", language: "TypeScript", updatedAt: null, stargazerCount: 0 },
  { name: "OptimizerOS", description: "An intelligent code optimizer that analyzes time and space complexity, refactors algorithmic bottlenecks, and provides production-ready code with interactive diffs.", url: "https://github.com/Samarssj/OptimizerOS", homepageUrl: "https://optimizeros.onrender.com", language: "TypeScript", updatedAt: "2026-08-24T13:17:15Z", stargazerCount: 0 },
  { name: "step-pulse", description: "Fitness tracking app using Firebase, Gemini-based coaching, and real-time step logging.", url: "https://github.com/Samarssj/step-pulse", homepageUrl: "https://step-pulse.vercel.app", language: "TypeScript", updatedAt: null, stargazerCount: 0 },
