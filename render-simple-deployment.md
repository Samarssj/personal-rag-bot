...
**The only required secret is `GEMINI_API_KEY`.** Add an optional server-only `GITHUB_TOKEN` if you want frequent live project-catalog, resume-link, and certification-catalog refreshes to avoid GitHub API rate limits.
