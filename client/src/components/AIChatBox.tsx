...
export function AIChatBox({
  ...
  useEffect(() => {
    if (isLoading && latestMessageContent) scrollToBottom();
  }, [isLoading, latestMessageContent]);
          ...
          <div className="flex h-full flex-col p-4">
            <div className="flex flex-1 flex-col items-center justify-center gap-6 text-muted-foreground">
              <div className="flex flex-col items-center gap-3">
                <span aria-hidden="true" className="font-serif text-5xl font-bold opacity-20">S</span>
                  ...
                  >
                    {message.role === "assistant" && (
                      <div className="size-8 shrink-0 mt-1 rounded-full bg-primary/10 flex items-center justify-center">
                        <span aria-label="Samar" className="font-serif text-sm font-bold text-primary">S</span>
                      </div>
                    )}
